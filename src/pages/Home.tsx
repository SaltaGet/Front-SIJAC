      ...
      >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 max-w-6xl mx-auto">
          {usersData?.map((user, idx) => (
            ...
            >
              <div className="absolute w-full h-full rounded-xl shadow-md border border-gray-200 transition-transform duration-700 [transform-style:preserve-3d] group-hover:[transform:rotateY(180deg)]">
                {/* Frente */}
                <div
                ...
                >
                  <h3 className="font-bold text-xl mb-2 text-center">
                    ...
                    {user.last_name.toUpperCase()} - ABOGADA
                    {user.specialty.toLowerCase().includes("mediaciones extrajudiciales") &&
